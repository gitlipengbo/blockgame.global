...
<title><?php echo ($room["roomid"]); ?>号九人牛牛八倍房间</title>
...
$(function() {  
  ...
  var title  = '星辰:九人牛牛八倍(房号:<?php echo ($room["roomid"]); ?>)';//分享的标题
  var shareimg = 'http://'+window.location.hostname+'/fenxiang/rc_icon_bull9.png';//分享的图片
