...
.mm{position:fixed;z-index:0;height:100%;width:100%;left:0px;top:0px;right:0px;bottom:0px;background:#615555;filter:alpha(Opacity=50);opacity:0.5;z-index:10;}
.game .img{width:36vw;position:absolute;height:42vw;background-size:36vw42vw;}
.img{margin-left:1%;margin-right:1%;margin-top:5%;width:38%;float:left;padding-left:5%;padding-right:5%}
.bullPart{position:fixed;bottom:48vw;left:0;width:100%;height:168vw;background:url("/app/images/baihu/back.png");background-size:100% 100%;margin-bottom:-128vw;transition:all 0.2s;z-index:99;}
.flowerPart{position:fixed;bottom:48vw;left:0;width:100%;height:48vw;background:url("/app/images/baihu/back.png");background-size:100% 100%;margin-bottom:-48vw;-webkit-transition:all .6s;transition:all .6s;z-index:99;}
.sangongPart{position:fixed;bottom:88vw;left:0;width:100%;height:88vw;background:url("/app/images/baihu/back.png");background-size:100% 100%;margin-bottom:-88vw;-webkit-transition:all .6s;transition:all .6s;z-index:99;}
  </style>
 ...
 <body style="background: #000;height: 100%;width: 100%;" class="onscope"> 
  ...
  <img id="1" class="cjfj-home-img1" src="http://goss.fexteam.com/files/common/images/home2/bull.png">
  <img id="2" class="cjfj-home-img2" src="http://goss.fexteam.com/files/common/images/home2/flower.png">
  <img id="3" class="cjfj-home-img3" src="http://goss.fexteam.com/files/common/images/home2/sangong.png">
  <img src="http://goss.fexteam.com/files/d_30/images/newhome/2fish.png" class="cjfj-home-img4" onclick="send('gameserver',{id:26})">
  <img src="http://goss.fexteam.com/files/d_30/images/newhome/2paijiu.png" class="cjfj-home-img5" onclick="send('gameserver',{id:27})">
  <img src="http://goss.fexteam.com/files/d_30/images/newhome/2scroll.png" class="cjfj-home-img7" onclick="send('gameserver',{id:6})">
  ...
  <div class="bullPart">
  <img class="img" src="http://goss.fexteam.com/files/common/images/home2/b.png" onclick="send('gameserver',{id:1})">
  <img class="img" src="http://goss.fexteam.com/files/common/images/home2/b9.png" onclick="send('gameserver',{id:2})">
  <img class="img" src="http://goss.fexteam.com/files/common/images/home2/b98.png" onclick="send('gameserver',{id:14})">
  <img class="img" src="http://goss.fexteam.com/files/common/images/home2/b12.png" onclick="send('gameserver',{id:10})">
<!--   <img class="img" src="/youxi/baihu.png" onclick="send('gameserver',{id:15})"> -->

  <div style="clear:both;"></div>
  </div>
  <div class="flowerPart">
  <img class="img" src="http://goss.fexteam.com/files/common/images/home2/f.png" onclick="send('gameserver',{id:5})">
  <img class="img" src="http://goss.fexteam.com/files/common/images/home2/f9.png" onclick="send('gameserver',{id:16})">
  
   <div style="clear:both;"></div>
  </div>
  <div class="sangongPart">
  <img class="img" src="http://goss.fexteam.com/files/common/images/home2/sj.png" onclick="send('gameserver',{id:17})">
  <img class="img" src="http://goss.fexteam.com/files/common/images/home2/s.png" onclick="send('gameserver',{id:3})">
  <img class="img" src="http://goss.fexteam.com/files/common/images/home2/s9.png" onclick="send('gameserver',{id:4})">
