...
<link rel="stylesheet" type="text/css" href="https://gameoss.fexteam.com/files/common/css/home/hhomepage2-1.0.1.css">
...
<script>
  ...
  <style type="text/css">
.createRoom .mainPart .cancelCreate{z-index:200;cursor:pointer;}.bottomMessage{position:fixed;bottom:0.75vh;right:2vh;width:4.5vh;height:4.5vh;z-index:91;}.bottomHistory{position:fixed;bottom:0.75vh;right:21.5vh;width:4.5vh;height:4.5vh;z-index:112;}.mm{position:fixed;z-index:0;height:100%;width:100%;left:0px;top:0px;right:0px;bottom:0px;background:#615555;filter:alpha(Opacity=50);opacity:0.5;z-index:10;}.game .img{width:36vw;position:absolute;height:42vw;background-size:36vw 42vw;}.img{margin-left:1%;margin-right:1%;margin-top:5%;width:38%;float:left;padding-left:5%;padding-right:5%}.bullPart{position:fixed;bottom:48vw;left:0;width:100%;height:168vw;background:url("/app/images/qilin/back.png");background-size:100% 100%;margin-bottom:-128vw;-webkit-transition:all .4s;transition:all .4s;z-index:99;}.flowerPart{position:fixed;bottom:48vw;left:0;width:100%;height:48vw;background:url("/app/images/qilin/back.png");background-size:100% 100%;margin-bottom:-48vw;-webkit-transition:all .6s;transition:all .6s;z-index:99;}.sangongPart{position:fixed;bottom:48vw;left:0;width:100%;height:88vw;background:url("/app/images/qilin/back.png");background-size:100% 100%;margin-bottom:-88vw;-webkit-transition:all .6s;transition:all .6s;z-index:99;}
  </style>
 ...
 <body style="background: #000;height: 100%;width: 100%;" class="onscope"> 
  ...
  <img id="1" class="cjfj-home-img1" src="http://goss.fexteam.com/files/common/images/home6/bull.png">
  <img id="2" class="cjfj-home-img2" src="http://goss.fexteam.com/files/common/images/home6/flower.png">
  <img id="3" class="cjfj-home-img3" src="http://goss.fexteam.com/files/common/images/home6/sangong.png">
  <img src="http://goss.fexteam.com/files/d_30/images/newhome/6fish.png" class="cjfj-home-img4" onClick="send('gameserver',{id:26})">
  <img src="http://goss.fexteam.com/files/d_30/images/newhome/6paijiu.png" class="cjfj-home-img5" onClick="send('gameserver',{id:27})">

  <img src="http://goss.fexteam.com/files/d_30/images/newhome/6scroll.png" class="cjfj-home-img7" onClick="send('gameserver',{id:6})">
  ...
  <div class="bullPart">
  <img class="img" src="http://goss.fexteam.com/files/common/images/home6/b.png" onClick="send('gameserver',{id:1})">
  <img class="img" src="http://goss.fexteam.com/files/common/images/home6/b9.png" onClick="send('gameserver',{id:2})">
  <img class="img" src="http://goss.fexteam.com/files/common/images/home6/b98.png" onClick="send('gameserver',{id:14})">
  <img class="img" src="http://goss.fexteam.com/files/common/images/home6/b12.png" onClick="send('gameserver',{id:10})">

  <div style="clear:both;"></div>
  </div>
  <div class="flowerPart">
  <img class="img" src="http://goss.fexteam.com/files/common/images/home6/f.png" onClick="send('gameserver',{id:5})">
  <img class="img" src="http://goss.fexteam.com/files/common/images/home6/f9.png" onClick="send('gameserver',{id:16})">
  
   <div style="clear:both;"></div>
  </div>
  <div class="sangongPart">
  <img class="img" src="http://goss.fexteam.com/files/common/images/home6/sj.png" onClick="send('gameserver',{id:17})">
  <img class="img" src="http://goss.fexteam.com/files/common/images/home6/s.png" onClick="send('gameserver',{id:3})">
  <img class="img" src="http://goss.fexteam.com/files/common/images/home6/s9.png" onClick="send('gameserver',{id:4})">
