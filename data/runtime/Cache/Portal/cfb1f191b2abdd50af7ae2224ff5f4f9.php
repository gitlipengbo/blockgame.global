...
<!--   <div class="user chuangjfj-yonghuimg" onclick="location.href='<?php echo U('portal/user/index');?>'" style="z-index: 102;"> 
  ...
  <div id="allgame11" style="width: 100%;height: auto;    position: absolute;z-index: 93;  "> 
    <img src="/skin/xn/1.png" class="cjfj-home-img1" onclick="send('gameserver',{id:1})">  
    <img src="/skin/xn/2.png" class="cjfj-home-img2" onclick="send('gameserver',{id:2})">      
    <img src="/skin/xn/10.png" class="cjfj-home-img3" onclick="send('gameserver',{id:10})">  
    <img src="/skin/xn/14.png" class="cjfj-home-img4" onclick="send('gameserver',{id:14})">  
    <img src="/skin/xn/5.png" class="cjfj-home-img5" onclick="send('gameserver',{id:5})">  
    <img src="/skin/xn/4.png" class="cjfj-home-img6" onclick="send('gameserver',{id:4})">      
    <img src="/skin/xn/6.png" class="cjfj-home-img7" onclick="send('gameserver',{id:6})"> 
   </div>
