    ...
    <div class='gameMenu-zt'>
      <div class="swiper-container swiper-container-horizontal swiper-container-free-mode">
       <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class='daoluan' data-id="27"></div>
          <div id="game27" class="gameListItem gameListItem3" >
              <img class='gameListItems' src="/themes/game/Public/img/activity/paijiu.png" /> 
              <div class='gameListItem-wz'>
               牌九
              </div>
             </div>
          ...
          <div id="game26" class="gameListItem gameListItem3" >
              <img class='gameListItems' src="/themes/game/Public/img/activity/fish.png" /> 
              <div class='gameListItem-wz'>
               12鱼虾蟹
              </div>
             </div>
