...
<link rel="stylesheet" type="text/css" href="/app/css/bull_vue-1.0.4.css">
...
$(function() {  
  ...
  var title  = '星辰:十二人牛牛(房号:<?php echo ($room["roomid"]); ?>)';//分享的标题
  var shareimg = 'http://'+window.location.hostname+'/fenxiang/rc_icon_bull12.png';//分享的图片
...
<div id="valert2" class="alert">
  ...
  <?php exit(); endif; ?>
   ...
   <img src="/app/img/common/note5.png" class="return shier-return" onclick="opnemm('fangjian_tishi','tishi')"/> 
...
"></div> 
   ...
   <div id="table" class="table">
    <img src="/app/img/bull12/back.jpg" class="tableBack" /> 
