<?php if (!defined('THINK_PATH')) exit();?><html>
 <head> 
  ...
  <title><?php echo ($room["roomid"]); ?>号六人牛牛房间</title>
...
<script>
  ...
  var title  = '星辰:六人牛牛(房号:<?php echo ($room["roomid"]); ?>)';//分享的标题
  var shareimg = 'http://'+window.location.hostname+'/fenxiang/rc_icon_bull.png';//分享的图片
